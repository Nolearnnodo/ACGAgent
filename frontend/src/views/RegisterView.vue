...
<template>
  <div class="auth-page">
    <form class="auth-card" @submit.prevent="handleSubmit">
      <h1>注册账号</h1>
      <p>创建一个普通用户账号，后续可在数据库中手动提升为管理员。</p>
      ...
      <label>
        密码
        <input v-model="formState.password" type="password" placeholder="至少 6 位" required />
      </label>
      ...
      <RouterLink to="/login" class="auth-card__link">已有账号？去登录</RouterLink>
    </form>
  </div>
</template>
